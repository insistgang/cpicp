...
SLIDES = [
    # P1 封面
    {
        ...
        "tag": "赛题2 · 典籍与日常",
        "bg": "fig_cover.png",
        "notes": "一部书，如何走过一千四百年，走进寻常人家——这是《颜氏家训》的生命史。",
    },
    # P2 选题缘起
    {
        "kind": "content",
        ...
        "img": None,
        "notes": ("颜之推，生于南北朝乱世，历经四朝。他写这部家训，"
                  "不是为了名垂青史，而是为了教子保家。"
                  "中国第一部体系化家训，就这样在战火中诞生了。"),
    },
    # P3 版本流变
    {
        "kind": "content",
        ...
        "notes": ("从手抄本到雕版刻本，再到明清坊刻普及本，"
                  "书越印越便宜，越传越广。"
                  "每一次技术变革，都让这部书离普通人更近一步。"),
    },
    # P4 传播下沉
    {
        "kind": "content",
        ...
        "notes": ("最初只在士族家学中流传，后来进入蒙学教材，"
                  "被族谱家规引用，最终融入民间婚丧嫁娶、年节礼仪——"
                  "这就是“大传统”走向“小传统”的路径。"),
    },
    # P5 教化主题
    {
        ...
        "bullets": [
            ...
            "治家、教子、勉学、慕贤——高频教化关键词浮现。",
            "这些词，就是这部书教给中国人的生活智慧。",
        ],
        "img": "fig_wordcloud.png",
        "notes": ("我们用数字人文的方法，提取了全书的主题词——"
                  "治家、教子、勉学、慕贤——这些关键词，"
                  "就是这部书教给中国人的生活智慧。"),
    },
    # P6 互文网络
    {
        ...
        "img": "fig_network.png",
        "notes": ("《颜氏家训》不是孤立的。从《温公家范》到"
                  "《朱子家训》再到《弟子规》，一条家训的脉络清晰可见。"
                  "这就是知识传承的网络。"),
    },
    # P7 当代启示
    {
        ...
        "img": None,
        "notes": ("今天，家风家教被重新提起，古籍数字化让千年典籍触手可及。"
                  "典籍中的智慧，依然在回答当代人的生活问题。"),
    },
    # P8 结语
    {
