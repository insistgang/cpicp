...
`python run_real_pipeline.py`            标准规模(快)
...
def main():
    ...
    if a.selftest:
        ...
        run(n_normal=100, n_defect=30, n_test_normal=700, n_test_defect=320, size=160, grid=8)
    else:
        print("=== run_real_pipeline (标准规模) ===")
        run(n_normal=100, n_defect=30, n_test_normal=400, n_test_defect=200, size=160, grid=8)
