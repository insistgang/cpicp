#!/usr/bin/env python3
"""
build_all_deliverables.py · 一键产出本地可生成的交付物草稿(配图 + 报告图表 + 两份 docx)
...
顺序固定(docx 会内嵌前两步的图):
  ...
  3) gen_tech_plan_docx   → output/docx/技术方案_初稿.docx                 (交付物①,内嵌上面 4 张图)
  4) gen_perf_report_docx → output/docx/性能报告_初稿.docx                 (交付物③,内嵌 3 张性能图)
